...
"font: 10pt \"OCR A Extended\";")
        ...
        self.sum_count = QtWidgets.QSpinBox(self.gridLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.sum_count.sizePolicy().hasHeightForWidth())
        self.sum_count.setSizePolicy(sizePolicy)
        self.sum_count.setObjectName("sum_count")
        self.gridLayout.addWidget(self.sum_count, 0, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Letsgo.clicked.connect(self.code_text)
        self.code_Btn.setText(_translate("MainWindow", "Coding"))
        self.Letsgo.clicked.connect(self.decode_text)
